<?php
    ...
    $projects_sql = "INSERT IGNORE INTO projects (title, description, image_path, link_url, category, date_completed) VALUES
        ('Student Management System', 'Web app for student records.', 'assets/img/projects/student-management.jpg', '#', 'Web App', '2025-01-15'),
        ('Portfolio Website', 'My personal portfolio.', 'assets/img/projects/portfolio.webp', '#', 'Website', '2024-12-20'),
        ('E-Commerce Website', 'Shopping platform.', 'assets/img/projects/e-commerce.png', '#', 'Web Development', '2024-11-30'),
        ('E-Commerce Website 2', 'Shopping platform.', 'assets/img/projects/e-commerce.png', '#', 'Web Development', '2024-11-30')";
